...
//        a.setBounds(a.getBounds().x, Utils.scale(100), a.getBounds().width, a.getBounds().height);
    ...
    public void paintComponent(Graphics g){
        ...
        CustomButton messageButton = new CustomButton(message, maxX/2, Utils.scale(40), Utils.scale(0), Utils.scale(80), null);
        messageButton.draw(g, panel);
        
        menuMessage = a.getMessage();
        CustomButton menuMessageButton = new CustomButton(menuMessage, maxX/2, Utils.scale(100), Utils.scale(0), Utils.scale(80), null);
